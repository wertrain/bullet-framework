...
//#include "Framework/Foundation/MinMax.h"
#ifdef B3_USE_GLFW
...
#endif  //__APPLE__
#endif  //B3_USE_GLFW
#include "Framework/OpenGLWindow/GLInstancingRenderer.h"

#include <string.h>
//#include "DemoSettings.h"
#include <stdio.h>

#include "Framework/Foundation/Vector3.h"
#include "Framework/Foundation/Quaternion.h"
#include "Framework/Foundation/Transform.h"
#include "Framework/Foundation/Matrix3x3.h"
#include "Framework/Foundation/ResizablePool.h"

#include "Framework/OpenGLWindow/LoadShader.h"

#include "Framework/OpenGLWindow/GLInstanceRendererInternalData.h"

//GLSL shader strings, embedded using build3/stringify
#include "Framework/OpenGLWindow/Shaders/pointSpriteVS.h"
#include "Framework/OpenGLWindow/Shaders/pointSpritePS.h"
#include "Framework/OpenGLWindow/Shaders/instancingVS.h"
#include "Framework/OpenGLWindow/Shaders/instancingPS.h"
#include "Framework/OpenGLWindow/Shaders/createShadowMapInstancingVS.h"
#include "Framework/OpenGLWindow/Shaders/createShadowMapInstancingPS.h"
#include "Framework/OpenGLWindow/Shaders/useShadowMapInstancingVS.h"
#include "Framework/OpenGLWindow/Shaders/useShadowMapInstancingPS.h"
#include "Framework/OpenGLWindow/Shaders/projectiveTextureInstancingVS.h"
#include "Framework/OpenGLWindow/Shaders/projectiveTextureInstancingPS.h"

#include "Framework/OpenGLWindow/Shaders/segmentationMaskInstancingVS.h"
#include "Framework/OpenGLWindow/Shaders/segmentationMaskInstancingPS.h"

#include "Framework/OpenGLWindow/Shaders/linesPS.h"
#include "Framework/OpenGLWindow/Shaders/linesVS.h"

#include "Framework/OpenGLWindow/GLRenderToTexture.h"
...
void GLInstancingRenderer::writeSingleInstanceSpecularColorToCPU(const double* specular, int srcIndex2)
{
	...
	if (gfxObjIndex > 0)
	{
		m_graphicsInstances[gfxObjIndex]->m_materialSpecularColor[0] = static_cast<float>(specular[0]);
		m_graphicsInstances[gfxObjIndex]->m_materialSpecularColor[1] = static_cast<float>(specular[1]);
		m_graphicsInstances[gfxObjIndex]->m_materialSpecularColor[2] = static_cast<float>(specular[2]);
	}
}
...
void GLInstancingRenderer::writeSingleInstanceScaleToCPU(const double* scale, int srcIndex2)
{
	...
	m_data->m_instance_scale_ptr[srcIndex * 4 + 0] = static_cast<float>(scale[0]);
	m_data->m_instance_scale_ptr[srcIndex * 4 + 1] = static_cast<float>(scale[1]);
	m_data->m_instance_scale_ptr[srcIndex * 4 + 2] = static_cast<float>(scale[2]);
	caster2 c;
	c.setInt(srcIndex2);
	m_data->m_instance_scale_ptr[srcIndex * 4 + 3] = c.getFloat();
}
...
{
	m_data->m_lightPos[0] = static_cast<float>(lightPos[0]);
	m_data->m_lightPos[1] = static_cast<float>(lightPos[1]);
	m_data->m_lightPos[2] = static_cast<float>(lightPos[2]);
}
