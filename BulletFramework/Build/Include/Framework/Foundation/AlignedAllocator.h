...
*/
#ifndef FRAMEWORK_FOUNDATION_ALIGNEDALLOCATOR_H_
#define FRAMEWORK_FOUNDATION_ALIGNEDALLOCATOR_H_

///we probably replace this with our own aligned memory allocator
///so we replace _aligned_malloc and _aligned_free with our own
///that is better portable and more predictable

#include "Framework/Foundation/Scalar.h"
...
//template <typename T, unsigned Alignment>
//using AlignedAllocator = b3AlignedAllocator<T type, unsigned Alignment>;

#endif // FRAMEWORK_FOUNDATION_ALIGNEDALLOCATOR_H_
